...
interface ItemBarLikeProps {
  children?: string;
  itemId: string;
  counterLike: number;
}

const ItemLikeStyled = styled.div`
...
const ItemBarLike: React.FC<StyledComponentProps<'div', DefaultTheme, ItemBarLikeProps, never>> = ({
  itemId,
  counterLike,
}) => {
  ...
  return (
    ...
    >
      <ItemLikeStyled>
        ...
        <span>{data ? data.likePost.likesCount : counterLike}</span>
      </ItemLikeStyled>
    </ItemLikeContainer>
  );
};

export default ItemBarLike;
